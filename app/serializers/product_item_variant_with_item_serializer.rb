class ProductItemVariantWithItemSerializer < ActiveModel::Serializer
  attributes :id, :product_item_id, :product_item_name, :product_item_brand,
             :price_of_variant, :one_image_of_variant, :rating_and_review, :color, :price
