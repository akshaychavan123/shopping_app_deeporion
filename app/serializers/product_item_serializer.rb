class ProductItemSerializer < ActiveModel::Serializer
  attributes :id, :name, :brand, :is_tax_inclusive, :image, :photos, :height, :price_of_first_variant, :discounted_price_of_first_variant, :discount_percent_of_first_variant, :expected_delivery, :product_code, :payment_method, :is_favorite, :product_id, :productdetails, :specification,:created_at, :in_stock
